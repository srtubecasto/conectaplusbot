...
// Bot criado por @ConectaPlus código original
...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			...
			[$tlg->buildInlineKeyboardButton ('👑 Ser Revendedor 👑', null, '/sobre')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Venha ganhar uma renda extra revendendo com o nosso painel de SSH, entre em contato com @ConectaPlus!
		Bot criado por @ConectaPlus todos os direitos reservados.'
	]);
